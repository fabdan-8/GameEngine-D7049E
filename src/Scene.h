...
class Scene {
public:
	std::string AddEntity(std::string name, float scale = 1.0f, float start_x = 0.0f, float start_y = 0.0f, float start_z = 0.0f, std::string interaction_script = "", std::string update_script = "");
